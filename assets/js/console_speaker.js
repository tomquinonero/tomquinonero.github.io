  ...
  console_speaker(
	...
	|(@)]   /~~[_____]~~\\   [(@)|
	 ...
	 ==============================	
      ...
      console_style +
      `font-style:italic;">help()</span><span style="` +
      console_style +
      `"> for list 
	       available commands
	            V 0.2.3
...
For see my skills, type </span><span style="font-weight:bold; ` +
      console_style +
      `">skills()</span><span style="` +
      console_style +
      `">, for contact me type </span><span style="font-weight:bold; ` +
      console_style +
      `">contact()</span><span style="font-weight:bold;` +
      console_style +
      `">
		  </span>`
  );
  ...
  console_speaker(
    `
      ...
      ` font-weight: normal">
		...
		You can send me a mail at</span><span style="` +
      console_style +
      `">
      ...
      console_style +
      ` font-weight: normal">
		I'm also available by phone :</span><span style="` +
      console_style +
      `">
